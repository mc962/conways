...
const init = () => {
  ...
  let rulesBox = $('.rules-container');
  let controlsBox = $('.controls-container');
  let leftButton = $('.left-arrow-nav-btn');
  let rightButton = $('.right-arrow-nav-btn');
  leftButton.on('click', () => revealRules(rulesBox, controlsBox, leftButton, rightButton));
  rightButton.on('click', () => revealControls(rulesBox, controlsBox, leftButton, rightButton));
...
const revealRules = (rules, controls, leftBtn, rightBtn) => {
...
const revealControls = (rules, controls, leftBtn, rightBtn) => {
